...
class Game(object):
    def __init__(self):
        ...
        self.data = levelparser.get_objects((0, 0), 35, self.screen, fruit_kill_function)
    ...
    def next_wave(self):
        ...
        self.num_fruits = len(self.current_wave[levelparser.STATIC_FRUITS]) + len(self.current_wave)
